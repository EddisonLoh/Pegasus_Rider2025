...
/* harmony import */ var _data_bb424ba8_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./data-bb424ba8.js */ 74804);
...
const DatetimeButton = class {
  constructor(hostRef) {
    ...
    this.setDateTimeText = () => {
      ...
      const parsedDatetimes = (0,_data_bb424ba8_js__WEBPACK_IMPORTED_MODULE_6__.s)(parsedValues.length > 0 ? parsedValues : [(0,_data_bb424ba8_js__WEBPACK_IMPORTED_MODULE_6__.x)()]);
      ...
      const computedHourCycle = (0,_data_bb424ba8_js__WEBPACK_IMPORTED_MODULE_6__.L)(locale, hourCycle);
      this.dateText = this.timeText = undefined;

      switch (datetimePresentation) {
        case 'date-time':
        case 'time-date':
          const dateText = (0,_data_bb424ba8_js__WEBPACK_IMPORTED_MODULE_6__.N)(locale, firstParsedDatetime, (_a = formatOptions === null || formatOptions === void 0 ? void 0 : formatOptions.date) !== null && _a !== void 0 ? _a : {
            month: 'short',
            day: 'numeric',
            year: 'numeric'
          });
          const timeText = (0,_data_bb424ba8_js__WEBPACK_IMPORTED_MODULE_6__.M)(locale, firstParsedDatetime, computedHourCycle, formatOptions === null || formatOptions === void 0 ? void 0 : formatOptions.time);
        ...
        case 'date':
          if (multiple && parsedValues.length !== 1) {
            ...
            this.dateText = (0,_data_bb424ba8_js__WEBPACK_IMPORTED_MODULE_6__.N)(locale, firstParsedDatetime, (_b = formatOptions === null || formatOptions === void 0 ? void 0 : formatOptions.date) !== null && _b !== void 0 ? _b : {
              month: 'short',
              day: 'numeric',
              year: 'numeric'
            });
        ...
        case 'time':
          this.timeText = (0,_data_bb424ba8_js__WEBPACK_IMPORTED_MODULE_6__.M)(locale, firstParsedDatetime, computedHourCycle, formatOptions === null || formatOptions === void 0 ? void 0 : formatOptions.time);
          break;

        case 'month-year':
          this.dateText = (0,_data_bb424ba8_js__WEBPACK_IMPORTED_MODULE_6__.N)(locale, firstParsedDatetime, (_c = formatOptions === null || formatOptions === void 0 ? void 0 : formatOptions.date) !== null && _c !== void 0 ? _c : {
            month: 'long',
            year: 'numeric'
          });
          break;
        ...
        case 'month':
          this.dateText = (0,_data_bb424ba8_js__WEBPACK_IMPORTED_MODULE_6__.N)(locale, firstParsedDatetime, (_d = formatOptions === null || formatOptions === void 0 ? void 0 : formatOptions.time) !== null && _d !== void 0 ? _d : {
            month: 'long'
          });
          break;

        case 'year':
          this.dateText = (0,_data_bb424ba8_js__WEBPACK_IMPORTED_MODULE_6__.N)(locale, firstParsedDatetime, (_e = formatOptions === null || formatOptions === void 0 ? void 0 : formatOptions.time) !== null && _e !== void 0 ? _e : {
            year: 'numeric'
          });
          break;
      }
    ...
    this.waitForDatetimeChanges = /*#__PURE__*/(0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        datetimeEl
      } = _this;
      ...
      return new Promise(resolve => {
        (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_2__.a)(datetimeEl, 'ionRender', resolve, {
          once: true
        });
      });
    });
    ...
    this.presentOverlay = /*#__PURE__*/function () {
      var _ref3 = (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev, needsPresentationChange, triggerEl) {
        const {
          overlayEl
        } = _this;
  ...
  componentWillLoad() {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_2__.c)(datetimeEl, () => {
        ...
        (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_2__.a)(datetimeEl, 'ionValueChange', _this2.setDateTimeText);
        /**
  ...
  render() {
    ...
    return (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      key: 'ab6c21a4c185dee71c8f14cafad82e38831c68d0',
      class: (0,_theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_4__.c)(color, {
        [mode]: true,
        [`${selectedButton}-active`]: datetimeActive,
        ['datetime-button-disabled']: disabled
      })
    }, dateText && (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
      key: 'cbda6f3386c3714567a04b5a97a96c71d59822c8',
      ...
      key: 'a00ff431512827bfef8c02982ef37099b2f21508',
      name: "date-target"
    }, dateText), mode === 'md' && (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", {
      key: '67935989628a2ed0492edb813fb0475bfd88abe7'
    })), timeText && (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
      key: '4207c94de5bece91b8388332e0192d1756403e62',
      class: "ion-activatable",
      id: "time-button",
      "aria-expanded": datetimeActive ? 'true' : 'false',
      ...
      key: '9ffa7ef4417571933bd1757950ec805c49704759',
      name: "time-target"
    }, timeText), mode === 'md' && (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", {
      key: 'fbcad00cf828c9719074d1d06f4e13246b28903e'
    })));
  }
