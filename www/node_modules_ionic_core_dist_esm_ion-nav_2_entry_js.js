...
/* harmony import */ var _index_fae1515c_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./index-fae1515c.js */ 57221);
...
/* harmony import */ var _framework_delegate_ed4ba327_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./framework-delegate-ed4ba327.js */ 38066);
...
class ViewController {
  ...
  init(container) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (!_this.element) {
        ...
        _this.element = yield (0,_framework_delegate_ed4ba327_js__WEBPACK_IMPORTED_MODULE_6__.a)(_this.delegate, container, component, ['ion-page', 'ion-page-invisible'], _this.params);
      }
    })();
  }
  /**
  ...
  _destroy() {
    (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.o)(this.state !== VIEW_STATE_DESTROYED, 'view state must be ATTACHED');
...
const matches = (view, id, params) => {
  ...
  return (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.s)(view.params, params);
};
...
const Nav = class {
  ...
  componentWillLoad() {
    ...
    if (this.swipeGesture === undefined) {
      ...
      this.swipeGesture = _ionic_global_94f25d1b_js__WEBPACK_IMPORTED_MODULE_5__.c.getBoolean('swipeBackEnabled', mode === 'ios');
    }
  ...
  componentDidLoad() {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.gesture = (yield __webpack_require__.e(/*! import() */ "common").then(__webpack_require__.bind(__webpack_require__, /*! ./swipe-back-37a22d34.js */ 96452))).createSwipeBackGesture(_this2.el, _this2.canStart.bind(_this2), _this2.onStart.bind(_this2), _this2.onMove.bind(_this2), _this2.onEnd.bind(_this2));
  ...
  disconnectedCallback() {
    for (const view of this.views) {
      (0,_index_fae1515c_js__WEBPACK_IMPORTED_MODULE_4__.l)(view.element, _index_fae1515c_js__WEBPACK_IMPORTED_MODULE_4__.d);
  ...
  prepareTI(ti) {
    ...
    if (ti.removeView !== undefined) {
      (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.o)(ti.removeStart !== undefined, 'removeView needs removeStart');
      (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.o)(ti.removeCount !== undefined, 'removeView needs removeCount');
    ...
    (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.o)(insertViews.length > 0, 'length can not be zero');
  ...
  postViewInit(enteringView, leavingView, ti) {
    ...
    (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.o)(leavingView || enteringView, 'Both leavingView and enteringView are null');
    (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.o)(ti.resolve, 'resolve must be valid');
    (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.o)(ti.reject, 'reject must be valid'); // Compute the views to remove.
    ...
    if (removeStart !== undefined && removeCount !== undefined) {
      (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.o)(removeStart >= 0, 'removeStart can not be negative');
      (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.o)(removeCount >= 0, 'removeCount can not be negative');
      destroyQueue = [];
    ...
    (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.o)(finalNumViews >= 0, 'final balance can not be negative');
    ...
    if (destroyQueue && destroyQueue.length > 0) {
      for (const view of destroyQueue) {
        (0,_index_fae1515c_js__WEBPACK_IMPORTED_MODULE_4__.l)(view.element, _index_fae1515c_js__WEBPACK_IMPORTED_MODULE_4__.b);
        (0,_index_fae1515c_js__WEBPACK_IMPORTED_MODULE_4__.l)(view.element, _index_fae1515c_js__WEBPACK_IMPORTED_MODULE_4__.c);
        (0,_index_fae1515c_js__WEBPACK_IMPORTED_MODULE_4__.l)(view.element, _index_fae1515c_js__WEBPACK_IMPORTED_MODULE_4__.d);
  ...
  transition(enteringView, leavingView, ti) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const mode = (0,_ionic_global_94f25d1b_js__WEBPACK_IMPORTED_MODULE_5__.b)(_this0);
      ...
      const animationOpts = Object.assign(Object.assign({
        ...
        baseEl: _this0.el,
        progressCallback,
        animated: _this0.animated && _ionic_global_94f25d1b_js__WEBPACK_IMPORTED_MODULE_5__.c.getBoolean('animated', true),
        enteringEl,
        leavingEl
      }, opts), {
        animationBuilder: opts.animationBuilder || _this0.animation || _ionic_global_94f25d1b_js__WEBPACK_IMPORTED_MODULE_5__.c.get('navAnimation')
      });
      const {
        hasCompleted
      } = yield (0,_index_fae1515c_js__WEBPACK_IMPORTED_MODULE_4__.t)(animationOpts);
  ...
  insertViewAt(view, index) {
    ...
    if (existingIndex > -1) {
      (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.o)(view.nav === this, 'view is not part of the nav'); // The view already in the stack, removes it.

      views.splice(existingIndex, 1); // and add it back at the requested index.

      views.splice(index, 0, view);
    } else {
      (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.o)(!view.nav, 'nav is used'); // this is a new view to add to the stack
  ...
  removeView(view) {
    (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.o)(view.state === VIEW_STATE_ATTACHED || view.state === VIEW_STATE_DESTROYED, 'view state should be loaded or destroyed');
    const views = this.views;
    const index = views.indexOf(view);
    (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.o)(index > -1, 'view must be part of the stack');
    ...
    for (let i = views.length - 1; i >= 0; i--) {
      ...
      if (element) {
        if (i > activeViewIndex) {
          ...
          // let's unload it
          (0,_index_fae1515c_js__WEBPACK_IMPORTED_MODULE_4__.l)(element, _index_fae1515c_js__WEBPACK_IMPORTED_MODULE_4__.d);
          this.destroyView(view);
        } else if (i < activeViewIndex) {
          // this view comes before the active view
          // and it is not a portal then ensure it is hidden
          (0,_index_fae1515c_js__WEBPACK_IMPORTED_MODULE_4__.s)(element, true);
        }
      }
    }
  }
