...
/* harmony import */ var _framework_delegate_ed4ba327_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./framework-delegate-ed4ba327.js */ 38066);
/* harmony import */ var _helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers-be245865.js */ 586);
/* harmony import */ var _lock_controller_316928be_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./lock-controller-316928be.js */ 49590);
/* harmony import */ var _index_9b0d46f4_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index-9b0d46f4.js */ 16746);
/* harmony import */ var _overlays_b874c3c3_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./overlays-b874c3c3.js */ 60403);
/* harmony import */ var _ionic_global_94f25d1b_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ionic-global-94f25d1b.js */ 1589);
/* harmony import */ var _theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./theme-01f3f29c.js */ 43827);
/* harmony import */ var _index_fae1515c_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index-fae1515c.js */ 57221);
/* harmony import */ var _animation_6a0c5338_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./animation-6a0c5338.js */ 37937);
/* harmony import */ var _index_a5d50daf_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./index-a5d50daf.js */ 16192);
/* harmony import */ var _hardware_back_button_6107a37c_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./hardware-back-button-6107a37c.js */ 8030);
...
const configureDismissInteraction = (triggerEl, triggerAction, popoverEl, parentPopoverEl) => {
  ...
  const root = (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.g)(parentPopoverEl);
  ...
  switch (triggerAction) {
    case 'hover':
      ...
      triggerCallbacks = [{
        eventName: 'mouseenter',
        callback: function () {
          var _ref = (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
            ev.stopPropagation();
...
const focusItem = item => {
  const root = (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.g)(item);
  const button = root.querySelector('button');

  if (button) {
    (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.r)(() => button.focus());
  }
};
/**
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const root = (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.g)(baseEl);
  ...
  const baseAnimation = (0,_animation_6a0c5338_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const backdropAnimation = (0,_animation_6a0c5338_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const contentAnimation = (0,_animation_6a0c5338_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  backdropAnimation.addElement(root.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']); // In Chromium, if the wrapper animates, the backdrop filter doesn't work.
  ...
  contentAnimation.addElement(root.querySelector('.popover-arrow')).addElement(root.querySelector('.popover-content')).fromTo('opacity', 0.01, 1); // TODO(FW-4376) Ensure that arrow also blurs when translucent
...
const mdEnterAnimation = (baseEl, opts) => {
  ...
  const baseAnimation = (0,_animation_6a0c5338_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const backdropAnimation = (0,_animation_6a0c5338_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const wrapperAnimation = (0,_animation_6a0c5338_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const contentAnimation = (0,_animation_6a0c5338_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const viewportAnimation = (0,_animation_6a0c5338_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  backdropAnimation.addElement(root.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverDidPresent", 7);
    this.willPresent = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverWillPresent", 7);
    this.willDismiss = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverWillDismiss", 7);
    this.didDismiss = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverDidDismiss", 7);
    ...
    this.coreDelegate = (0,_framework_delegate_ed4ba327_js__WEBPACK_IMPORTED_MODULE_2__.C)();
    this.lockController = (0,_lock_controller_316928be_js__WEBPACK_IMPORTED_MODULE_4__.c)();
    this.inline = false;
    this.focusDescendantOnPresent = false;

    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_b874c3c3_js__WEBPACK_IMPORTED_MODULE_6__.B);
    };
  ...
  connectedCallback() {
    ...
    (0,_overlays_b874c3c3_js__WEBPACK_IMPORTED_MODULE_6__.j)(el);
    configureTriggerInteraction();
  }
  ...
  componentWillLoad() {
    ...
    const popoverId = (0,_overlays_b874c3c3_js__WEBPACK_IMPORTED_MODULE_6__.k)(el);
    this.parentPopover = el.closest(`ion-popover:not(#${popoverId})`);

    if (this.alignment === undefined) {
      this.alignment = (0,_ionic_global_94f25d1b_js__WEBPACK_IMPORTED_MODULE_7__.b)(this) === 'ios' ? 'center' : 'start';
    }
  }
  ...
  componentDidLoad() {
    ...
    if (parentPopover) {
      (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.a)(parentPopover, 'ionPopoverWillDismiss', () => {
  ...
  presentFromTrigger(_x3) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, focusDescendant = false) {
  ...
  present(event) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.usersElement = yield (0,_framework_delegate_ed4ba327_js__WEBPACK_IMPORTED_MODULE_2__.a)(delegate, el, _this2.component, ['popover-viewport'], _this2.componentProps, inline);
      ...
      if ((0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.m)(el)) {
        yield (0,_index_fae1515c_js__WEBPACK_IMPORTED_MODULE_9__.e)(_this2.usersElement);
        /**
        ...
        yield (0,_index_fae1515c_js__WEBPACK_IMPORTED_MODULE_9__.w)();
      }

      yield (0,_overlays_b874c3c3_js__WEBPACK_IMPORTED_MODULE_6__.f)(_this2, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, {
      ...
      if (_this2.focusDescendantOnPresent) {
        (0,_overlays_b874c3c3_js__WEBPACK_IMPORTED_MODULE_6__.n)(_this2.el, _this2.el);
      }
  ...
  dismiss(_x4, _x5) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data, role, dismissParentPopover = true) {
      ...
      const shouldDismiss = yield (0,_overlays_b874c3c3_js__WEBPACK_IMPORTED_MODULE_6__.g)(_this3, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, _this3.event);
      ...
      if (shouldDismiss) {
        ...
        yield (0,_framework_delegate_ed4ba327_js__WEBPACK_IMPORTED_MODULE_2__.d)(delegate, _this3.usersElement);
      }
  ...
  onDidDismiss() {
    return (0,_overlays_b874c3c3_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionPopoverDidDismiss');
  }
  /**
  ...
  onWillDismiss() {
    return (0,_overlays_b874c3c3_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionPopoverWillDismiss');
  }

  render() {
    const mode = (0,_ionic_global_94f25d1b_js__WEBPACK_IMPORTED_MODULE_7__.b)(this);
    const {
      onLifecycle,
      parentPopover,
      dismissOnSelect,
    ...
    const desktop = (0,_ionic_global_94f25d1b_js__WEBPACK_IMPORTED_MODULE_7__.a)('desktop');
    ...
    }), !parentPopover && (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-backdrop", {
      key: 'f7fbd914100838ed7d419eedd19e6b1efa691127',
      tappable: this.backdropDismiss,
      visible: this.showBackdrop,
      part: "backdrop"
    }), (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: 'a651cb4daa6556e761c2e2b672306ad25e4c9429',
      class: "popover-wrapper ion-overlay-wrapper",
      onClick: dismissOnSelect ? () => this.dismiss() : undefined
    }, enableArrow && (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: '7c5c7d8d6f9530535124e3fc75a38055f68b7589',
      class: "popover-arrow",
      part: "arrow"
    }), (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: '9f92fff4f36941e8f7de9774aef7d7508ca5cfe5',
      class: "popover-content",
      part: "content"
    }, (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      key: '26c4e3df40a4832caff996ead3321c656eb5704f'
    }))));
  }
