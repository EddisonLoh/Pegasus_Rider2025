...
const PickerInternal = class {
  constructor(hostRef) {
    ...
    this.ionInputModeChange = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionInputModeChange", 7);
  ...
  componentWillLoad() {
    (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_2__.g)(this.el).addEventListener('focusin', this.onFocusIn);
    (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_2__.g)(this.el).addEventListener('focusout', this.onFocusOut);
  }
  /**
   * @internal
  ...
  render() {
    ...
    }, (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
