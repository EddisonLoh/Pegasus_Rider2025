...
/* harmony import */ var _googlemaps_markerclusterer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @googlemaps/markerclusterer */ 22755);
/* harmony import */ var _definitions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./definitions */ 95325);
...
class CapacitorGoogleMapsWeb extends _capacitor_core__WEBPACK_IMPORTED_MODULE_1__.WebPlugin {
  ...
  importGoogleLib(apiKey, region, language) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this.gMapsRef === undefined) {
        const lib = yield __webpack_require__.e(/*! import() */ "node_modules_googlemaps_js-api-loader_dist_index_mjs").then(__webpack_require__.bind(__webpack_require__, /*! @googlemaps/js-api-loader */ 19921));
        ...
        _this.gMapsRef = google.maps; // Import marker library once

        const {
          AdvancedMarkerElement,
          PinElement
        } = yield google.maps.importLibrary('marker');
        _this.AdvancedMarkerElement = AdvancedMarkerElement;
        _this.PinElement = PinElement;
  ...
  getMapBounds(_args) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const bounds = _this0.maps[_args.id].map.getBounds();
  ...
  fitBounds(_args) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const map = _this1.maps[_args.id].map;

      const bounds = _this1.getLatLngBounds(_args.bounds);

      map.fitBounds(bounds, _args.padding);
    })();
  }

  addTileOverlay(_args) {
    var _this10 = this;

    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const tileOverlay = _args.tileOverlay;
      const map = _this10.maps[_args.id].map;
      const id = '' + _this10.currTileOverlayId;
      ...
      _this10.maps[_args.id].tileOverlays[id] = customMapOverlay;
      map.overlayMapTypes.push(customMapOverlay);
      _this10.currTileOverlayId++;
      return {
        id: id
      };
    })();
  ...
  removeTileOverlay(_args) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      for (let i = 0; i < map.overlayMapTypes.getLength(); i++) {
        if (map.overlayMapTypes.getAt(i) === _this11.maps[_args.id].tileOverlays[_args.tileOverlayId]) {
          map.overlayMapTypes.removeAt(i);
          delete _this11.maps[_args.id].tileOverlays[_args.tileOverlayId];
          break;
        }
      }
    })();
  ...
  addMarkers(_args) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      for (const markerArgs of _args.markers) {
        const advancedMarker = _this12.buildMarkerOpts(markerArgs, map.map);

        const id = '' + _this12.currMarkerId;
        map.markers[id] = advancedMarker;
        yield _this12.setMarkerListeners(_args.id, id, advancedMarker);
        markerIds.push(id);
  ...
  addMarker(_args) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const advancedMarker = _this13.buildMarkerOpts(_args.marker, _this13.maps[_args.id].map);

      const id = '' + _this13.currMarkerId;
      _this13.maps[_args.id].markers[id] = advancedMarker;
      yield _this13.setMarkerListeners(_args.id, id, advancedMarker);
  ...
  removeMarker(_args) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this15.maps[_args.id].markers[_args.markerId]) {
        _this15.maps[_args.id].markers[_args.markerId].map = null;
  ...
  disableClustering(_args) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const mapInstance = _this23.maps[_args.id];
  ...
  create(_args) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield _this24.importGoogleLib(_args.apiKey, _args.region, _args.language); // Ensure we have a Map ID for Advanced Markers

      const config = Object.assign({}, _args.config);

      if (!config.mapId) {
        config.mapId = `capacitor_map_${_this24.currMapId++}`;
      }
  ...
  setMapListeners(mapId) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      map.addListener('idle', /*#__PURE__*/(0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        var _a, _b;
      ...
      map.addListener('bounds_changed', /*#__PURE__*/(0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        var _a, _b;
...
/* harmony import */ var supercluster__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! supercluster */ 78342);
...
/* harmony export */ });
/* harmony import */ var kdbush__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! kdbush */ 29401);
