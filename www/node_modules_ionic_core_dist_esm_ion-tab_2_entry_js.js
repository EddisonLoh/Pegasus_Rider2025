...
const Tab = class {
  ...
  prepareLazyLoaded() {
    if (!this.loaded && this.component != null) {
      ...
      try {
        return (0,_framework_delegate_ed4ba327_js__WEBPACK_IMPORTED_MODULE_2__.a)(this.delegate, this.el, this.component, ['ion-page']);
      } catch (e) {
        console.error(e);
      }
    }
...
const Tabs = class {
  constructor(hostRef) {
    ...
    this.ionTabsWillChange = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionTabsWillChange", 3);
    this.ionTabsDidChange = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionTabsDidChange", 3);
