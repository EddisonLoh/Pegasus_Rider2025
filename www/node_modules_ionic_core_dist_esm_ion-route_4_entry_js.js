...
const Route = class {
  constructor(hostRef) {
    ...
    this.ionRouteDataChanged = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionRouteDataChanged", 7);
    this.url = '';
...
const RouteRedirect = class {
  constructor(hostRef) {
    (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.r)(this, hostRef);
    this.ionRouteRedirectChanged = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionRouteRedirectChanged", 7);
    this.from = undefined;
    this.to = undefined;
  }
...
const _writeNavState = /*#__PURE__*/function () {
  var _ref = (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (root, chain, direction, index, changed = false, animation) {
    try {
      ...
      yield new Promise(resolve => (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_2__.c)(outlet, resolve));
...
const readNavState = /*#__PURE__*/function () {
  var _ref2 = (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (root) {
    const ids = [];
    let outlet;
...
const Router = class {
  constructor(hostRef) {
    (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.r)(this, hostRef);
    this.ionRouteWillChange = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionRouteWillChange", 7);
    this.ionRouteDidChange = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionRouteDidChange", 7);
  ...
  componentDidLoad() {
    window.addEventListener('ionRouteRedirectChanged', (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_2__.q)(this.onRedirectChanged.bind(this), 10));
    window.addEventListener('ionRouteDataChanged', (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_2__.q)(this.onRoutesChanged.bind(this), 100));
  }
  ...
  push(_x6) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (path, direction = 'forward', animation) {
      var _a;
  ...
  safeWriteNavState(_x7, _x8, _x9, _x0, _x1) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, chain, direction, segments, redirectFrom, index = 0, animation) {
  ...
  runGuards() {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (to = _this0.getSegments(), from) {
      if (from === undefined) {
      ...
      const fromChain = findChainForSegments(from, routes); // eslint-disable-next-line @typescript-eslint/prefer-optional-chain
      ...
      const toChain = findChainForSegments(to, routes); // eslint-disable-next-line @typescript-eslint/prefer-optional-chain
  ...
  writeNavState(_x10, _x11, _x12, _x13, _x14) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, chain, direction, segments, redirectFrom, index = 0, animation) {
      ...
      _this1.busy = true; // generate route event and emit will change
      ...
      _this1.busy = false; // emit did change
...
const RouterLink = class {
  ...
  render() {
    ...
    return (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      key: 'e69892f4c6a6baf040a20c429afdec0e4db2dc0e',
      onClick: this.onClick,
      class: (0,_theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_3__.c)(this.color, {
        [mode]: true,
        'ion-activatable': true
      })
    }, (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("a", Object.assign({
      key: '648cb22526f2933abe0865c86da6f30eac3ccb87'
    }, attrs), (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      key: 'd6bc2e28b7c5cc228caedffebe653bde35934b67'
    })));
  }
