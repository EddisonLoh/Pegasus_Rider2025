...
/* harmony import */ var _index_f7dc70ba_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./index-f7dc70ba.js */ 19815);
...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.didLoad = false; // This flag ensures we log the deprecation warning at most once.
    ...
    this.disabled = false;
    this.value = 'on';
    this.enableOnOffLabels = _ionic_global_94f25d1b_js__WEBPACK_IMPORTED_MODULE_9__.c.get('toggleOnOffLabels');
  ...
  connectedCallback() {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this2.legacyFormController = (0,_form_controller_21dd62b1_js__WEBPACK_IMPORTED_MODULE_2__.c)(_this2.el);
      /**
  ...
  componentWillLoad() {
    ...
    if (!this.legacyFormController.hasLegacyControl()) {
      this.inheritedAttributes = Object.assign({}, (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.i)(this.el));
    }
  }
  ...
  renderToggleControl() {
    ...
    }, enableOnOffLabels && mode === 'ios' && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  renderToggle() {
    ...
    (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.d)(true, el, name, checked ? value : '', disabled);
    ...
    }, this.inheritedAttributes)), (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: {
        'label-text-wrapper': true,
        'label-text-wrapper-hidden': !this.hasLabel
      },
      part: "label"
    }, (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", null)), (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new toggle syntax.`, this.el);
    ...
    const {
      ...
      labelId,
      labelText
    } = (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.e)(el, inputId);
    const value = this.getValue();
    const rtl = (0,_dir_babeabeb_js__WEBPACK_IMPORTED_MODULE_6__.i)(el) ? 'rtl' : 'ltr';
    (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.d)(true, el, name, checked ? value : '', disabled);
    return (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.H, {
    ...
    }, this.renderToggleControl(), (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
      htmlFor: inputId
    }, labelText), (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
      type: "checkbox",
      role: "switch",
      "aria-checked": `${checked}`,
      disabled: disabled,
