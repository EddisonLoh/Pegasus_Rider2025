...
const Item = class {
  ...
  componentWillLoad() {
    this.inheritedAriaAttributes = (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_2__.k)(this.el, ['aria-label']);
  }
    ...
    if (counter && !this.multipleInputs && (inputEl === null || inputEl === void 0 ? void 0 : inputEl.maxlength) !== undefined) {
      ...
      if (counterFormatter === undefined) {
        ...
        try {
          ...
          (0,_index_9b0d46f4_js__WEBPACK_IMPORTED_MODULE_3__.a)('Exception in provided `counterFormatter`.', e); // Fallback to the default counter formatter when an exception happens
  ...
  render() {
    ...
    let clickFn = {};
    const firstInteractive = this.getFirstInteractive(); // Only set onClick if the item is clickable to prevent screen
    ...
    return (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      ...
      part: "native",
      disabled: disabled
    }, clickFn), (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      ...
      name: "end"
    }), showDetail && (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
    ...
    })), canActivate && mode === 'md' && (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", {
      ...
      name: "helper"
    }), counterString && (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-note", {
...
const Label = class {
  constructor(hostRef) {
    (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.r)(this, hostRef);
    this.ionColor = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionColor", 7);
