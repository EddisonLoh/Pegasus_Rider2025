...
/* harmony import */ var _index_f3946ac1_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-f3946ac1.js */ 5254);
/* harmony import */ var _form_controller_21dd62b1_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./form-controller-21dd62b1.js */ 46366);
...
const Range = class {
  constructor(hostRef) {
    ...
    this.ionKnobMoveStart = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionKnobMoveStart", 7);
    this.ionKnobMoveEnd = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionKnobMoveEnd", 7);
    ...
    this.contentEl = null;
    this.initialContentScrollY = true; // This flag ensures we log the deprecation warning at most once.

    this.hasLoggedDeprecationWarning = false;

    this.clampBounds = value => {
      return (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_4__.l)(this.min, value, this.max);
    };
    ...
    this.setupGesture = /*#__PURE__*/(0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const rangeSlider = _this.rangeSlider;

      if (rangeSlider) {
        _this.gesture = (yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-2cf77112.js */ 58428))).createGesture({
          el: rangeSlider,
          gestureName: 'range',
          gesturePriority: 100,
    ...
    this.handleKeyboard = (knob, isIncrease) => {
      ...
      if (knob === 'A') {
        this.ratioA = (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_4__.l)(0, this.ratioA + step, 1);
      } else {
        this.ratioB = (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_4__.l)(0, this.ratioB + step, 1);
      }
  ...
  componentWillLoad() {
    ...
    this.inheritedAttributes = (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_4__.i)(this.el);
  }
  ...
  connectedCallback() {
    ...
    this.legacyFormController = (0,_form_controller_21dd62b1_js__WEBPACK_IMPORTED_MODULE_3__.c)(el);
    this.updateRatio();
    ...
    this.contentEl = (0,_index_f3946ac1_js__WEBPACK_IMPORTED_MODULE_2__.f)(this.el);
  }
  ...
  onMove(detail) {
    ...
    if (contentEl && this.initialContentScrollY === undefined) {
      this.initialContentScrollY = (0,_index_f3946ac1_js__WEBPACK_IMPORTED_MODULE_2__.d)(contentEl);
    }
    /**
  ...
  onEnd(detail) {
    ...
    if (contentEl && initialContentScrollY !== undefined) {
      (0,_index_f3946ac1_js__WEBPACK_IMPORTED_MODULE_2__.r)(contentEl, initialContentScrollY);
  ...
  update(currentX) {
    ...
    let ratio = (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_4__.l)(0, (currentX - rect.left) / rect.width, 1);
  ...
  setPressedKnob(currentX) {
    const rect = this.rect = this.rangeSlider.getBoundingClientRect(); // figure out which knob they started closer to
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new range syntax.`, this.el);
    ...
    (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_4__.d)(true, el, this.name, JSON.stringify(this.getValue()), disabled);
    return (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      ...
      name: "start"
    }), this.renderRangeSlider(), (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      name: "end"
    }));
  }
  /**
  ...
  renderRange() {
    ...
    return (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      ...
      part: "label"
    }, label !== undefined ? (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "label-text"
    }, label) : (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      name: "label"
    })), (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  renderRangeSlider() {
    ...
    let {
      labelText
    } = (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_4__.e)(el, rangeId);
    ...
    }, ticks.map(tick => (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
...
const renderKnob = (rtl, {
  ...
  return (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    ...
    "aria-valuenow": value
  }, pin && (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-pin",
    role: "presentation",
    part: "pin"
  }, pinFormatter(value)), (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-knob",
    role: "presentation",
    part: "knob"
  }));
...
const ratioToValue = (ratio, min, max, step) => {
  ...
  const clampedValue = (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_4__.l)(min, value, max);
  return roundToMaxDecimalPlaces(clampedValue, min, max, step);
};

const valueToRatio = (value, min, max) => {
  return (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_4__.l)(0, (value - min) / (max - min), 1);
};
