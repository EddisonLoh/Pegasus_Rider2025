...
/* harmony import */ var _index_2cf77112_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./index-2cf77112.js */ 58428);
...
/* harmony import */ var _framework_delegate_ed4ba327_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./framework-delegate-ed4ba327.js */ 38066);
...
const createSwipeToDismissGesture = (el, toastPosition, onDismiss) => {
   ...
   */
  const wrapperEl = (0,_helpers_be245865_js__WEBPACK_IMPORTED_MODULE_3__.g)(el).querySelector('.toast-wrapper');
  ...
  const swipeAnimation = (0,_animation_6a0c5338_js__WEBPACK_IMPORTED_MODULE_9__.c)('toast-swipe-to-dismiss-animation').addElement(wrapperEl)
  /**
  ...
  const gesture = (0,_index_2cf77112_js__WEBPACK_IMPORTED_MODULE_11__.createGesture)({
    ...
    gesturePriority: _overlays_b874c3c3_js__WEBPACK_IMPORTED_MODULE_6__.O,
...
const Toast = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastDidPresent", 7);
    this.willPresent = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastWillPresent", 7);
    this.willDismiss = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastWillDismiss", 7);
    this.didDismiss = (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastDidDismiss", 7);
    ...
    this.createSwipeGesture = toastPosition => {
      const gesture = this.gesture = createSwipeToDismissGesture(this.el, toastPosition, () => {
         ...
         */
        this.dismiss(undefined, _overlays_b874c3c3_js__WEBPACK_IMPORTED_MODULE_6__.G);
      });
      gesture.enable(true);
    };
    /**
    ...
    this.duration = _ionic_global_94f25d1b_js__WEBPACK_IMPORTED_MODULE_8__.c.getNumber('toastDuration', 0);
  ...
  present() {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const animationPosition = getAnimationPosition(position, anchor, (0,_ionic_global_94f25d1b_js__WEBPACK_IMPORTED_MODULE_8__.b)(_this), el);
      /**
      ...
      yield (0,_overlays_b874c3c3_js__WEBPACK_IMPORTED_MODULE_6__.f)(_this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, {
        position,
  ...
  dismiss(data, role) {
    ...
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const dismissed = yield (0,_overlays_b874c3c3_js__WEBPACK_IMPORTED_MODULE_6__.g)(_this2, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation,
      /**
  ...
  onDidDismiss() {
    return (0,_overlays_b874c3c3_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionToastDidDismiss');
  }
  /**
  ...
  onWillDismiss() {
    return (0,_overlays_b874c3c3_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionToastWillDismiss');
  }
  ...
  callButtonHandler(button) {
    return (0,C_Users_user_STABLE_Pegasus_Rider2025_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button === null || button === void 0 ? void 0 : button.handler) {
        ...
        try {
          const rtn = yield (0,_overlays_b874c3c3_js__WEBPACK_IMPORTED_MODULE_6__.s)(button.handler);
  ...
  renderButtons(buttons, side) {
    ...
    }, buttons.map(b => (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", Object.assign({}, b.htmlAttributes, {
      type: "button",
      class: buttonClass(b),
      tabIndex: 0,
    ...
    }), b.text), mode === 'md' && (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", {
  ...
  render() {
    ...
    return (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.H, Object.assign({
      key: '23803334fb668f6ce7044d3a321cb84bc753bd16',
      tabindex: "-1"
    }, this.htmlAttributes, {
      style: {
      ...
      key: '7cd7138ba079fccf97f318b91e9986491ab4214d',
      class: wrapperClass
    }, (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: '93b78fa64e24435adeb77a04c1d1d53d2f093864',
      class: "toast-container",
      part: "container"
    }, this.renderButtons(startButtons, 'start'), this.icon !== undefined && (0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
      key: '9a3c71b164ebcfba2540acb7568beffa76b62f47',
      class: "toast-icon",
      part: "icon",
      icon: this.icon,
      lazy: false,
      ...
      key: 'feb9268102d844f1314205f7440de7066cf0620e',
      class: "toast-content",
      role: "status",
      "aria-atomic": "true",
      "aria-live": "polite"
...
const buttonPart = button => {
  return (0,_overlays_b874c3c3_js__WEBPACK_IMPORTED_MODULE_6__.i)(button.role) ? 'button cancel' : 'button';
};
